 ...
 @override
  ...
  void removeStatusBar() {
    ...
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      statusBarColor: Colors.transparent, // Change the status bar color if needed
      statusBarBrightness: Brightness.dark, // Change the status bar brightness if needed
    ));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: TextApp.appBarText('profile'),),
