    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const SizedBox(height: 60), // Add space above the welcome messages
            Padding(
            ...
            const SizedBox(height: 20), // Add space below the welcome messages
            Center(
              child: Row(
...
Get.to(SchuldePage(userEmail: email??"",));
print(email ?? "no");
                        },
                        child: Container(
                          color: Colors.transparent,
